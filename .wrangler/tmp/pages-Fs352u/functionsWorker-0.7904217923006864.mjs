...
function computeSaju(input) {
  ...
  const addPillarElements = /* @__PURE__ */ __name((gan, zhi) => {
    const stem = STEM_HANJA_TO_HANGUL[gan];
    const branch = BRANCH_HANJA_TO_HANGUL[zhi];
...
// ../.wrangler/tmp/pages-Fs352u/functionsRoutes-0.40299578624161625.mjs
var routes = [
  {
    routePath: "/api/saju",
    mountPath: "/api",
...
// ../.wrangler/tmp/bundle-R1nfYQ/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-R1nfYQ/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.7904217923006864.mjs.map
