...
// .wrangler/tmp/pages-Fs352u/functionsWorker-0.7904217923006864.mjs
var __defProp2 = Object.defineProperty;
var __name2 = /* @__PURE__ */ __name((target, value) => __defProp2(target, "name", { value, configurable: true }), "__name");
var _SolarUtil = class {
  static {
    __name(this, "_SolarUtil");
  }
  static {
    __name2(this, "_SolarUtil");
  }
...
var SolarWeek = class _SolarWeek {
  static {
    __name(this, "_SolarWeek");
  }
  static {
    __name2(this, "SolarWeek");
  }
...
var _LunarUtil = class {
  static {
    __name(this, "_LunarUtil");
  }
  static {
    __name2(this, "_LunarUtil");
  }
...
var Holiday = class _Holiday {
  static {
    __name(this, "_Holiday");
  }
  static {
    __name2(this, "Holiday");
  }
...
var _HolidayUtil = class {
  static {
    __name(this, "_HolidayUtil");
  }
  static {
    __name2(this, "_HolidayUtil");
  }
  static _padding(n) {
    return (n < 10 ? "0" : "") + n;
  }
...
var TaoFestival = class {
  static {
    __name(this, "TaoFestival");
  }
  static {
    __name2(this, "TaoFestival");
  }
...
var FotoFestival = class {
  static {
    __name(this, "FotoFestival");
  }
  static {
    __name2(this, "FotoFestival");
  }
...
var _FotoUtil = class {
  static {
    __name(this, "_FotoUtil");
  }
  static {
    __name2(this, "_FotoUtil");
  }
...
var NineStarUtil = class {
  static {
    __name(this, "NineStarUtil");
  }
  static {
    __name2(this, "NineStarUtil");
  }
};
NineStarUtil.NUMBER = [
  "{n.one}",
...
var EightChar = class _EightChar {
  static {
    __name(this, "_EightChar");
  }
  static {
    __name2(this, "EightChar");
  }
  constructor(lunar) {
    this._sect = 2;
    this._lunar = lunar;
...
var _NineStar = class {
  static {
    __name(this, "_NineStar");
  }
  static {
    __name2(this, "_NineStar");
  }
...
var LunarMonth = class _LunarMonth {
  static {
    __name(this, "_LunarMonth");
  }
  static {
    __name2(this, "LunarMonth");
  }
...
var _ShouXingUtil = class {
  static {
    __name(this, "_ShouXingUtil");
  }
  static {
    __name2(this, "_ShouXingUtil");
  }
  static decode(s) {
    const o = "0000000000";
    const o2 = o + o;
...
var _LunarYear = class {
  static {
    __name(this, "_LunarYear");
  }
  static {
    __name2(this, "_LunarYear");
  }
...
var LunarTime = class _LunarTime {
  static {
    __name(this, "_LunarTime");
  }
  static {
    __name2(this, "LunarTime");
  }
...
var SolarMonth = class _SolarMonth {
  static {
    __name(this, "_SolarMonth");
  }
  static {
    __name2(this, "SolarMonth");
  }
...
__name(parseBirthDate, "parseBirthDate");
__name2(parseBirthDate, "parseBirthDate");
function parseBirthTime(value) {
  if (!value) return { hour: 12, minute: 0 };
  const match2 = value.match(/^(\d{2}):(\d{2})$/);
  if (!match2) return { hour: 12, minute: 0 };
  return {
    hour: Number(match2[1]),
    minute: Number(match2[2])
  };
}
__name(parseBirthTime, "parseBirthTime");
__name2(parseBirthTime, "parseBirthTime");
function getPillarValue(gan, zhi, hideGanList) {
...
__name(getPillarValue, "getPillarValue");
__name2(getPillarValue, "getPillarValue");
function classifyStrength(count, total) {
...
__name(classifyStrength, "classifyStrength");
__name2(classifyStrength, "classifyStrength");
function computeSaju(input) {
  ...
  if (input.calendarType === "lunar") {
    const lunar2 = Lunar.fromYmd(dateParts.year, dateParts.month, dateParts.day);
    solar = lunar2.getSolar();
  } else {
  ...
  const addPillarElements = /* @__PURE__ */ __name2((gan, zhi) => {
    const stem = STEM_HANJA_TO_HANGUL[gan];
    const branch = BRANCH_HANJA_TO_HANGUL[zhi];
  ...
  const sortedElements = Object.keys(elementCount).sort(
    (a, b) => elementCount[a] - elementCount[b]
  );
  return {
    adjustedBirthDate: `${solar.getYear()}-${pad(solar.getMonth())}-${pad(solar.getDay())}`,
    calendarAssumptionNote: input.calendarType === "lunar" ? "\uC74C\uB825\uC740 \uC591\uB825\uC73C\uB85C \uBCC0\uD658 \uD6C4 \uACC4\uC0B0\uB418\uC5C8\uC2B5\uB2C8\uB2E4." : void 0,
    year: yearPillar,
    month: monthPillar,
    day: dayPillar,
    hour: hourPillar,
...
__name(computeSaju, "computeSaju");
__name2(computeSaju, "computeSaju");
function getSexagenaryYear(year) {
  const lunar = Lunar.fromYmd(year, 1, 1);
  return lunar.getYearInGanZhi();
}
__name(getSexagenaryYear, "getSexagenaryYear");
__name2(getSexagenaryYear, "getSexagenaryYear");
var ZODIAC_FULL_MAP = {
  "\u767D\u7F8A\u5EA7": { en: "Aries", ko: "\uC591\uC790\uB9AC" },
...
function getZodiacSign(birthDate, calendarType = "solar") {
...
__name2(getZodiacSign, "getZodiacSign");
var corsHeaders = {
...
async function callOpenAI(apiKey, model, systemInstruction, userPrompt) {
...
var onRequestOptions = /* @__PURE__ */ __name2(async ({ request, env }) => {
...
var onRequestPost = /* @__PURE__ */ __name2(async ({ request, env }) => {
  ...
  const systemInstruction = isEn ? `You are an expert Saju (Four Pillars of Destiny) analyst and astrology consultant.
       Write the report in English.
       Use Markdown formatting and separate sections with H2 (##) headers.` : `\uB2F9\uC2E0\uC740 \uC804\uBB38 \uC0AC\uC8FC \uBD84\uC11D\uAC00\uC774\uC790 \uC810\uC131\uC220 \uC0C1\uB2F4\uC0AC\uC785\uB2C8\uB2E4.
       \uACB0\uACFC\uB294 \uB9C8\uD06C\uB2E4\uC6B4\uC73C\uB85C \uC791\uC131\uD558\uACE0, \uAC01 \uC139\uC158\uC744 H2(##)\uB85C \uBD84\uB9AC\uD558\uC138\uC694.`.trim();
  const userPrompt = isEn ? `Write a Saju analysis report based on the following:
       ...
       11) Saju-based ${hobby} Style & Advice (Last section, exclude specific training plans)` : `\uB2E4\uC74C \uC815\uBCF4\uB97C \uBC14\uD0D5\uC73C\uB85C \uC0AC\uC8FC \uB9AC\uD3EC\uD2B8\uB97C \uC791\uC131\uD574\uC918.
...
function buildCorsHeaders2(origin, allowedOrigins) {
  if (!allowedOrigins) return { "Access-Control-Allow-Origin": "*" };
  const allowlist = new Set(allowedOrigins.split(",").map((item) => item.trim()).filter(Boolean));
  if (origin && allowlist.has(origin)) return { "Access-Control-Allow-Origin": origin };
  return { "Access-Control-Allow-Origin": "null" };
}
__name(buildCorsHeaders2, "buildCorsHeaders2");
__name2(buildCorsHeaders2, "buildCorsHeaders");
function jsonResponse(status, body, origin, allowedOrigins) {
  return new Response(JSON.stringify(body), {
    status,
    headers: {
      ...corsHeaders2,
      ...buildCorsHeaders2(origin, allowedOrigins),
...
async function callOpenAI2(apiKey, model, systemInstruction, userPrompt) {
  const response = await fetch("https://api.openai.com/v1/chat/completions", {
    method: "POST",
    headers: {
      Authorization: `Bearer ${apiKey}`,
...
__name(callOpenAI2, "callOpenAI2");
__name2(callOpenAI2, "callOpenAI");
var onRequestOptions2 = /* @__PURE__ */ __name2(async ({ request, env }) => {
  const origin = request.headers.get("Origin");
  return new Response(null, {
    status: 204,
    headers: { ...corsHeaders2, ...buildCorsHeaders2(origin, env.ALLOWED_ORIGINS) }
  });
}, "onRequestOptions");
var onRequestPost2 = /* @__PURE__ */ __name2(async ({ request, env }) => {
  ...
  const apiKey = env.OPENAI_API_KEY;
  if (!apiKey) {
    const isEn2 = body.lang === "en";
    const hobby2 = body.hobby || "Golf";
    const zodiacSign = body.zodiacSign || "auto";
    const bloodType = body.bloodType || "unknown";
    const mockReport = isEn2 ? `## Analysis Report for ${body.clientName} (MOCK)
...
- Estimated: ENTJ
### 5. Hobby Advice
- Advice for ${hobby2}...` : `## ${body.clientName}\uB2D8\uC758 \uC0AC\uC8FC \uBD84\uC11D \uB9AC\uD3EC\uD2B8 (MOCK)
...
### 5. \uCDE8\uBBF8(${hobby2}) \uC870\uC5B8
- ${hobby2} \uD65C\uB3D9 \uC2DC\uC5D0\uB294 \uD3C9\uC815\uC2EC\uC744 \uC720\uC9C0\uD558\uB294 \uAC83\uC774 \uC911\uC694\uD558\uBA70, \uD2B9\uD788 \uC624\uD6C4 \uC2DC\uAC04\uB300\uAC00 \uD589\uC6B4\uC744 \uAC00\uC838\uB2E4\uC904 \uAC83\uC785\uB2C8\uB2E4.
...
- \uC870\uC5B8: \uD604\uC7AC \uC6B4\uC758 \uAE30\uC6B4\uC744 \uBCF4\uC558\uC744 \uB54C, \uC774 \uBB38\uC81C\uB294 \uC2DC\uAC04\uC744 \uB450\uACE0 \uD574\uACB0\uD558\uB294 \uAC83\uC774 \uAE38\uD569\uB2C8\uB2E4.` : ""}`;
  ...
  const selectedZodiac = body.zodiacSign && body.zodiacSign !== "auto" ? String(body.zodiacSign) : zodiacData.ko;
  const isEn = body.lang === "en";
  const hobby = body.hobby || (isEn ? "Golf" : "\uACE8\uD504");
  const systemInstruction = isEn ? `You are an expert Saju (Four Pillars of Destiny) analyst and astrology consultant.
       Write the report in English.
       Use Markdown formatting and separate sections with H2 (##) headers.
       Address user's notes/questions at the end of the report if provided.`.trim() : `\uB2F9\uC2E0\uC740 \uC804\uBB38 \uC0AC\uC8FC \uBD84\uC11D\uAC00\uC774\uC790 \uC810\uC131\uC220 \uC0C1\uB2F4\uC0AC\uC785\uB2C8\uB2E4.
       \uC544\uB798 \uCD9C\uB825 \uD615\uC2DD\uC744 \uBC18\uB4DC\uC2DC \uC9C0\uD0A4\uC138\uC694.
       - \uB9C8\uD06C\uB2E4\uC6B4 \uD615\uC2DD
       - \uAC01 \uC139\uC158\uC740 H2(##) \uC81C\uBAA9 \uC0AC\uC6A9
       - \uC0AC\uC6A9\uC790\uC758 \uCD94\uAC00 \uC9C8\uBB38/\uBA54\uBAA8('notes')\uC5D0 \uB300\uD574\uC11C\uB294 \uBA85\uB9AC\uD559\uC801 \uAD00\uC810\uC5D0\uC11C \uB9C8\uC9C0\uB9C9\uC5D0 \uC0C1\uC138\uD788 \uB2F5\uBCC0\uD560 \uAC83`.trim();
  const userPrompt = isEn ? `Write a personalized Saju analysis report for ${body.clientName || "the client"}.
       ...
       12) Conclusion (5 lines summary)` : `${body.clientName || "\uC758\uB8B0\uC778"}\uB2D8\uC744 \uC704\uD55C \uAC1C\uC778\uD654\uB41C \uC0AC\uC8FC \uBD84\uC11D \uBCF4\uACE0\uC11C\uB97C \uC791\uC131\uD574\uC918.
...
\uB9C8\uC9C0\uB9C9\uC5D0 "\uC885\uD569 \uC694\uC57D" \uC139\uC158\uC73C\uB85C \uD575\uC2EC 5\uC904 \uC694\uC57D\uC744 \uCD94\uAC00\uD574\uC918.`;
  try {
    const reportMarkdown = await callOpenAI2(
      apiKey,
...
// .wrangler/tmp/bundle-gGMbXR/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-gGMbXR/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.7904217923006864.js.map
